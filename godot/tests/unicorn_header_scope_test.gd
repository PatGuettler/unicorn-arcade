...
func _run() -> void:
	...
	_check(coin_icon != null and coin_icon.text == "★" and coin_icon.tooltip_text == "Coins" and coin_icon.get_theme_color("font_color") == Color("ffd166") and coin_icon.get_theme_constant("outline_size") == 3, "shared headers use the same accessible gold-star currency glyph as the main page")
